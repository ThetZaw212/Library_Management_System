...
namespace LMS.Report {
    ...
    public class crpt_Borrow : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "LMS.Report.crpt_Borrow.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedcrpt_Borrow : Component, ICachedReport {
        
        public Cachedcrpt_Borrow() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            crpt_Borrow rpt = new crpt_Borrow();
            rpt.Site = this.Site;
            return rpt;
        }
